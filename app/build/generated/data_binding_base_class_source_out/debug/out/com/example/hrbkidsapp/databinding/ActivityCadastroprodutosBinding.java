...
public final class ActivityCadastroprodutosBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityCadastroprodutosBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button button4, @NonNull Button button5, @NonNull EditText editTextNumberDecimal,
      ...
      @NonNull EditText editTextTextPostalAddress2, @NonNull ImageView imageView3,
      @NonNull TextView textNome, @NonNull TextView textView10, @NonNull TextView textView13,
      @NonNull TextView textView27, @NonNull TextView textView28, @NonNull TextView textView29,
      @NonNull TextView textView30, @NonNull TextView textView31, @NonNull TextView textView36,
      @NonNull TextView textView37, @NonNull TextView textView38, @NonNull TextView textView9,
  ...
  @NonNull
  public static ActivityCadastroprodutosBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCadastroprodutosBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_cadastroprodutos, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCadastroprodutosBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCadastroprodutosBinding((ConstraintLayout) rootView, button4, button5,
          editTextNumberDecimal, editTextPhone, editTextTextPersonEmail, editTextTextPersonName2,
          editTextTextPersonName7, editTextTextPostalAddress2, imageView3, textNome, textView10,
          textView13, textView27, textView28, textView29, textView30, textView31, textView36,
          textView37, textView38, textView9, topView, topView2);
    }
